...
A complete code example could be found on [GitHub](https://github.com/akveo/oliveui/tree/master/src/playground/oauth2).
And here the playground example avaible to play around with [OAuth2 oliveui Example](/example/oauth2).
